package com.green.cashback.greenCashback.config;
...
public class SwaggerConfig {
    ...
    public Docket swaggerConfiguration () {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.green.cashback.greenCashback.resource"))
    ...
    private ApiInfo getApiInfo () {
        ...
        return new ApiInfoBuilder()
                ...
                .description("Api with responsibility to serve like as api-gateway")
